...
C   ABOUT THE LOCAL MACHINE ON WHICH THE 1 ARCHIVE LIBRARY SOFTWARE
...
C   AND THIS IS NORMALLY DONE DURING THE FIRST CALL TO 1 ARCHIVE
...
C   LATER BY A DIFFERENT 1 ARCHIVE LIBRARY SUBROUTINE, IT WILL JUST
...
C  -----------------
     ...
     & '=============== 
     & WELCOME TO THE 1 ARCHIVE LIBRARY', ' =============='
      CALL ERRWRT(ERRSTR)
